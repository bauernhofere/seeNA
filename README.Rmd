...
```{r concordance, fig.width=11, fig.height=6, fig.alt="Two test-fixture profiles above a directional call-agreement track. A-only gains are teal; the fifth 1-Mb bin is grey for absent evidence. No patient data."}
...
```{r concordance-style, eval=FALSE}
plot_ichor_concordance(
