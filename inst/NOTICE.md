...
ichorCNA is licensed under GNU GPL version 3 and later, and its older releases
...
The files under `inst/extdata/` are deliberately small, generated format
fixtures with no clinical or biological interpretation. They contain no
patient data.
